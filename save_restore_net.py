# -*- coding: utf-8 -*-
"""
Created on Sat Dec  2 14:53:07 2017
...
train_images = mnist_data.load_train_images()
train_labels = mnist_data.load_train_labels()
test_labels = mnist_data.load_test_labels()
test_images = mnist_data.load_test_images()
